namespace ArtGalleryProblem
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            //MsgBox(this.ýmageList.Images.Count.ToString());
            /*this.ýmageList.Images.SetKeyName(0, "first.ico");
            this.ýmageList.Images.SetKeyName(1, "first.ico");
            this.ýmageList.Images.SetKeyName(2, "first.ico");
            this.ýmageList.Images.SetKeyName(3, "first.ico");
            this.ýmageList.Images.SetKeyName(4, "first.ico");*/
            // 
            // listBox1
            // 
            ...
            */// 
            ...
            this.Icon = ((System.Drawing.Icon)(resources.GetObject("$first.Icon")));
            this.Name = "Form1";
